...
import "./TopDestinations.css"; // Novi CSS

// Slike sa Unsplash-a (ili koristi tvoje lokalne ako ih imaš)
const DESTINATIONS = [
  { 
    city: "Zurich", 
    country: "Switzerland", 
  ...
  { 
    ...
    country: "Germany", 
    price: "€119", 
   img: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Stadtbild_M%C3%BCnchen.jpg/800px-Stadtbild_M%C3%BCnchen.jpg"
  },
];
    ...
    <section className="destinations-section">
      <div className="section-header" data-aos="fade-up">
        ...
        <p className="section-sub">
          Most popular routes this month. Book your next adventure directly from PRN.
        </p>
      </div>

      <div className="destinations-grid">
        {DESTINATIONS.map((dest, i) => (
          <div key={i} className="dest-card" data-aos="fade-up" data-aos-delay={i * 100}>
